...
app.post("/api/generate-structure", async (req, res) => {
    try {
        ...
        console.log("Generating project structure for:", description);
...
app.post("/api/confirm-structure", async (req, res) => {
    try {
        ...
        console.log("Confirming structure with feedback:", feedback);
...
app.post("/api/generate-code", async (req, res) => {
    try {
        ...
        if (!structure) {
            throw new Error('Structure is required for code generation');
        }
        console.log("Generating code for structure:", JSON.stringify(structure));
